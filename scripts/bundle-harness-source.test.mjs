...
function fixture() {
  ...
  write('packages/core/core/package.json', JSON.stringify({ name: '@fixture/core', main: 'lib/index.js', bin: 'bin.js', files: ['cordis.patch.yml'] }))
  write('packages/core/core/lib/index.js', 'export {}\n')
  write('packages/core/core/bin.js', '#!/usr/bin/env node\n')
  write('packages/core/core/cordis.patch.yml', '- insert: []\n')
...
test('bundleHarness copies only production inputs and creates a manifest', () => {
  ...
  assert.equal(readFileSync(join(output, 'packages/core/core/cordis.patch.yml'), 'utf8'), '- insert: []\n')
